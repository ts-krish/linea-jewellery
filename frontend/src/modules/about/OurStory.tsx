      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-5 justify-center ">
          ...
          <p className="text-black/70">
            ...
            pieces that transcend fleeting trends. Our founders, united by their
            passion for exceptional craftsmanship and sustainable practices,
            established the brand with a commitment to creating jewelry that
      ...
      <div className="flex flex-col mt-10 md:mt-30 gap-10">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          <div className="flex flex-col gap-5">
            <h3 className="font-medium text-xl ">Traditional Craftsmanship</h3>
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-black/50">
              ...
              commitment to ethical sourcing, recycled materials, and
